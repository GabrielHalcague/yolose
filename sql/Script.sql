...
( 'El protocolo a través del cuál se realiza todo el intercambio de datos entre un servidor web y un cliente es:', 5, 4, 1, 6),
( 'El protocolo HTTP tiene entre sus caracteristicas ser:', 5, 4, 1, 6),
( 'El protocolo DNS es:', 5, 4, 1, 6),
( 'El protocolo HTTP implementa comandos, entre ellos:', 5, 4, 1, 6),
( 'El protyocolo HTTP implementa codigos de error de respuesta, si recibo un codigo de la serie 500, ha ocurrido:', 5, 4, 1, 6),
( 'El protyocolo HTTP implementa codigos de error de respuesta, si recibo un codigo de la serie 400, ha ocurrido:', 5, 4, 1, 6),
( 'El protyocolo HTTP implementa codigos de error de respuesta, si recibo un codigo de la serie 200, ha ocurrido:', 5, 4, 1, 6),
( 'En una petición GET, los parametros de la petición se pasan a través de....', 5, 4, 1, 6),
( 'Se denomina Scripting del lado del cliente, o programación Front-end o Client Side Scripting a :', 5, 4, 1, 6),
( 'Se denomina Scripting del lado del servidor, o programación Back-end o Server Side Scripting a :', 5, 4, 1, 6),
( 'La petición de un recurso determinado a un sitio Web (imagen, archivo, etc.) se canaliza mediante:', 5, 4, 1, 6);
